...
preds_rf = make_predictions(model.main, train,train$fracture, "stepwise")
plot_roc("RF",preds_rf,0.2,0.8,T)
classification_metrics(0.22, model.main, "Step", train,train$fracture, "stepwise")

```
```{r}


preds_rf = make_predictions(model.main, test,test$fracture, "stepwise")
plot_roc("RF",preds_rf,0.2,0.8,T)
classification_metrics(0.22, model.main, "RF", test,test$fracture, "stepwise")
